...
\begin{tcolorbox}[title=Prompt Vietnamese Template Used in the System,fonttitle=\bfseries, breakable]
  \small
...
We also would like to thank the experts in the field of Psychological Psychological Health for providing data and professional materials, especially the Tam Ly Nhi Dong Clinic for supporting the research team in authenticating and consolidating professional knowledge for the RAG system.
...
Finally, we would like to thank our families, friends, colleagues, teachers, mentors, doctors and medical staffs of clinic for their unwavering support and encouragement, which have been invaluable in helping us complete this research.


\begin{thebibliography}{9}
\bibitem{b1} Yang, K., Zhang, T., Kuang, Z., Xie, Q., Huang, J., \& Ananiadou, S. (2024). ``MentaLLaMA: Interpretable Mental Health Analysis on Social Media with Large Language Models.'' arXiv preprint arXiv:2309.13567v3.

\bibitem{b2} Jiang, A. Q., Sablayrolles, A., Mensch, A., Bamford, C., Chaplot, D. S., de las Casas, D., Bressand, F., Lengyel, G., Lample, G., Saulnier, L., Lavaud, L. R., Lachaux, M.-A., Stock, P., Le Scao, T., Lavril, T., Wang, T., Lacroix, T., \& El Sayed, W. (2023). ``Mistral 7B: Towards Efficient and High-Performance Language Models.'' arXiv preprint arXiv:2302.13971.

\bibitem{b3} Nguyen, Q., Pham, H., \& Dao, D. (2023). ``VinaLLaMA: LLaMA-based Vietnamese Foundation Model.'' arXiv preprint arXiv:2312.11011v1.

\bibitem{b4} Nguyen, X.-P., Zhang, W., Li, X., Aljunied, M., Hu, Z., Shen, C., Chia, Y. K., Li, X., Wang, J., Tan, Q., Cheng, L., Chen, G., Deng, Y., Yang, S., Liu, C., Zhang, H., \& Bing, L. (2023). ``SeaLLMs: Large Language Models for Southeast Asia.'' arXiv preprint arXiv:2312.16934v2.

\bibitem{b5} Gao, Y., Xiong, Y., Gao, X., Jia, K., Pan, J., Bi, Y., Dai, Y., Sun, J., Wang, M., \& Wang, H. (2024). ``Retrieval-Augmented Generation for Large Language Models: A Survey.'' arXiv preprint arXiv:2312.10997v5.

\bibitem{b6} Hebert, L., Golab, L., Poupart, P., \& Cohen, R. (n.d.). ``FedFormer: Contextual Federation with Attention in Reinforcement Learning.'' [Unpublished manuscript].

\bibitem{b7} Hu, E. J., Shen, Y., Wallis, P., Allen-Zhu, Z., Li, Y., Wang, S., Wang, L., \& Chen, W. (2021). ``LoRA: Low-Rank Adaptation of Large Language Models.'' arXiv preprint arXiv:2106.09685.

\bibitem{b8} Lakatos, R., Pollner, P., Hajdu, A., \& Joó, T. (2024). ``Investigating the Performance of Retrieval-Augmented Generation and Fine-Tuning for the Development of AI-Driven Knowledge-Based Systems.'' arXiv preprint arXiv:2403.09727v1.

\bibitem{b9} Steck, H., Ekanadham, C., \& Kallus, N. (2024). ``Is Cosine-Similarity of Embeddings Really About Similarity?'' arXiv preprint arXiv:2403.05440v1.
